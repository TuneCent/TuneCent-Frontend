...
const ProfileRow = ({ userRole = "Creator" }: ProfileRowProps) => {
  ...
  return (
    <div className="w-full flex flex-row justify-between items-center border-b-[0.069vw] border-[#201C22] pb-[1.111vw]">
      <div className="flex flex-row gap-[1.667vw] items-center">
        {/* Logo */}
        {/* <div className="w-[2.778vw] aspect-[60/47] relative">
          <Image
            src="/assets/logo.png"
            alt="TuneCent Logo"
            fill
